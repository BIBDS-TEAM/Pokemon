...
public class PokemonFactory {
    public static Map<String, Pokemon> loadPokemonFromJson(String path, int value) throws Exception {
         Gson gson = new Gson();
        ...
        for (Map.Entry<String, PokemonData> entry : rawData.entrySet()) {
            ...
            Pokemon pokemon = new Pokemon(name, type, data.lvl, data.maxHp, data.atk, data.def, data.spAtk, data.spDef, data.spd);
    ...
    public static void main(String[] args) {
        try {
            Map<String, Pokemon> pokemonMap = loadPokemonFromJson("C:\\Users\\hasan\\Documents\\GitHub\\Pokemon\\Pokemon\\PokemonBasics\\PokemonAllType\\PokemonList.json", 5);
