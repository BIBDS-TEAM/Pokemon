...
public class PokemonMove_SPECIAL_SPATTACK extends PokemonMove{
    ...
    public PokemonMove_SPECIAL_SPATTACK(String moveName, int maxSp, String desc, int power, double accuracy, int minLvl, PokemonMoveType moveType, PokemonMoveCategory moveCategory) {
    ...
    public Map<String, String> move(Pokemon attacker, Pokemon defender) {
        ...
        if (isSpZero()) {
            ...
            if (this.accuracy <= accuracy) {
                ...
                double multiplier = PokemonMultiplier.getAttackMultiplier(attacker.getType(), defender.getType());
